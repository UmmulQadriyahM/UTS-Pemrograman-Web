...
include "koneksi.php"; // Database: Menghubungkan script dengan konfigurasi database MySQL

$id = $_GET['id'];

$query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE id='$id'"); // CRUD/Database: Read - Menjalankan query SQL untuk mengambil data siswa spesifik berdasarkan ID

$data = mysqli_fetch_assoc($query); // Database: Mengubah hasil query menjadi array asosiatif untuk siap digunakan
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card border-0 shadow rounded-4">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form action="CRUD/update.php" method="POST"> <input
    type="hidden"
    name="id"
    value="<?= $data['id']; ?>">
...
required>
    ...
    <?= ($data['jenis_kelamin'] == 'Perempuan') ? 'selected' : ''; ?>>
        ...
        Perempuan
                                        ...
                                        <button
                                            type="button"
                                            onclick="window.location.href='<?= $kembali ?>'" class="btn btn-primary rounded-pill px-4"
                                            style="
                                                min-width:130px;
                                                height:42px;
