...
<head>
    ...
    <title>Data Siswa Kelas VII</title>
...
<div class="dashboard">
    ...
    <div class="main">
        ...
        <div class="topbar">
            ...
            <h2>Data Siswa Kelas VII</h2>

            <p>Kelola data siswa kelas VII.</p>
        ...
        <div class="content">
            ...
            <div class="container-fluid mt-2">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="form.php?kelas=7&rombel=7A" class="btn btn-primary rounded-pill px-4">
