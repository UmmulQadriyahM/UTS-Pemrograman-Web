...
<head>
    ...
    <title>Data Siswa Kelas VIII</title>
...
<div class="dashboard">
    ...
    <div class="main">
        ...
        <div class="topbar">
            ...
            <h2>Data Siswa Kelas VIII</h2>

            <p>Kelola data siswa kelas VIII.</p>
        ...
        <div class="content">
            ...
            <div class="container-fluid mt-2">
                ...
                <div class="mb-3">
                    ...
                    <button
                    type="button"
                    onclick="window.location.href='siswa.php'" class="btn btn-primary rounded-pill px-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="form.php?kelas=8&rombel=8A" class="btn btn-primary rounded-pill px-4">
...
<tr>
    ...
    <td>
        ...
        onclick="return confirm('Yakin ingin menghapus data siswa ini?')"> <i class="bi bi-trash"></i>
